            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/laporanobatmasuk" method="GET">
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <?php else : ?>
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="/obatmasukpdf?dari_tanggal=<?= @$_GET['dari_tanggal']; ?>&sampai_tanggal=<?= @$_GET['sampai_tanggal']; ?>" target="_blank" class="btn btn-success mb-3"><i class="fas fa-file"></i> Cetak Laporan</a>
